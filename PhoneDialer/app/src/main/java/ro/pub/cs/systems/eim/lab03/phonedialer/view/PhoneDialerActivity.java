    ...
    private class ContactsImageButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (phoneNumber.length() > 0) {
                ...
                makeText(getApplication(), getResources().getString(R.string.phone_error), LENGTH_LONG).show();
            }
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        switch (requestCode) {
            case Constants.CONTACTS_MANAGER_REQUEST_CODE:
                makeText(this, "Activity returned with result " + resultCode, LENGTH_LONG).show();
                break;
        }
    }
}
